...
public class Updater : Editor
{
    ...
    private const string PackageName = "com.popcron.console";
    private const string PackageURL = "https://raw.githubusercontent.com/popcron/console/master/package.json";
    private const string CanUpdateKey = "Popcron.Console.CanUpdate";
    private const string CheckForUpdateText = "Popcron/Console/Check for updates";
    private const string UpdateText = "Popcron/Console/Update";
